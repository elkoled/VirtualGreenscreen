...
# inference resolution, 1.0 = full image resolution
inference_resolution = 0.3
...
def main():
    ...
    with pyvirtualcam.Camera(width=width, height=height, fps=target_fps) as cam:
        while True:
            ...
            frame = cv2.resize(webcam_frame, None, fx=inference_resolution, fy=inference_resolution, interpolation=cv2.INTER_AREA)
